...
const Login = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const loginreq = async () => {
      return await axios.post(`${BASE_URL}/users/login`, formData, { withCredentials: true });
    };
      ...
      <div className='grid grid-cols-1 lg:grid-cols-7 gap-8'>
        ...
        <div className='lg:col-span-3 flex flex-col items-center justify-center h-screen'>
          <h1 className='font-bold text-xl sm:text-2xl text-left uppercase mb-8'>
            Login WITH <span className='text-rose-600'>ABHIGRAM</span>
          </h1>
          <form
          ...
          >
            ...
            <div className='mb-4'>
              ...
              <Link href="/auth/forgotpassword" className='mt-2 text-red-500 block font-semibold text-base cursor-pointer text-right'>
              Forgot Password
              </Link>
            </div>
